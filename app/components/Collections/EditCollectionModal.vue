    ...
    <ModalWindow :open="open" @close="close">
        <div class="flex flex-col gap-4 w-110 max-w-[90vw]">
            ...
            <div v-if="collection && !collection.isPersonal" class="space-y-2">
                ...
                <div class="flex flex-wrap items-center justify-between gap-2">
                    <button
                        ...
                        :disabled="
                            !canLeave || leaving || memberSaving || deleting
                        "
                ...
                >
                    ...
                    <div class="text-sm opacity-80">
                        This will remove your access to this collection. This
                        can be re-granted later by an owner/editor.
                    </div>
                ...
                <!-- Transfer ownership confirmation -->
                <div
                    v-if="transferConfirmOpen"
                    class="border rounded-md p-3 space-y-2"
                >
                    <div class="text-sm font-semibold">Transfer ownership</div>
                    <div class="text-sm opacity-80">
                        Transferring ownership is irreversible from your
                        perspective. The new owner will become the sole owner,
                        and you will become an editor.
                    </div>
                ...
                >
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <input
                            ...
                            :disabled="
                                membersLoading || memberSaving || deleting
                            "
                    ...
                    <div v-else class="space-y-2">
                        ...
                        <div class="text-xs opacity-70">
                            Note: you cannot remove the owner. Delete the
                            collection or transfer ownership.
                        </div>
                    </div>
                </div>
            ...
            >
                ...
                <div class="text-xs opacity-70">
                    Deleting a collection removes it for all members. Books are
                    not deleted; only the collection and its links are removed.
                </div>

                <div
                    class="border border-(--error-color)/50 rounded-md p-3 space-y-2"
                >
                    <div class="text-sm">
